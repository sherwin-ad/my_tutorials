...
- [ ] Box 1: Open the release pipeline editor. Box 2: Enable Gates. Box 3: Add Query Work Items.
...
- [ ] Committed code must compile successfully: A build policy. Pull requests must have a Quality Gate status of Passed in SonarCloud: A status policy.
...
- [ ] Threshold value: 80%. Aggregation granularity (Period): 15 minutes.
...
- [ ] PowerShell Desired State Configuration (DSC) extension for Windows.
...
- [ ] Box 1: Get-AzResource. Box 2: -ResourceType.
...
- [ ] Project 1: Team Foundation Version Control. Project 2: Git. Project 3: Git. Project 4: Team Foundation Version Control.
...
- [ ] Box 1: Create a YAML file. Box 2: Run kubectl apply. Box 3: Run helm init.
...
- [ ] Box 1: kubectl create. Box 2: helm init. Box 3: helm install.
...
- [ ] Box 1: Upload a configuration to Azure Automation State Configuration. Box 2: Compile a configuration into a node configuration. Box 3: Onboard the virtual machines to Azure Automation State Configuration. Box 4: Assign the node configuration. Box 5: Check the compliance status of the node.
...
- [ ] Azure Logic Apps, Azure Application Insights.
